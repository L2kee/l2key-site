...
export const BLOG_BACKLOG: BlogPost[] = [
  // ---------- A. Vertical-specific SEO (14) ----------
  {
    ...
    sections: [
      { paragraphs: ["Plumbing is one of the most competitive local searches there is, and most of the demand is urgent. Someone searching \"emergency plumber\" or \"burst pipe repair\" is deciding in the next few minutes, not researching for next week."] },
      { heading: "Emergency keywords behave differently", paragraphs: ["A page built around \"24 hour plumber\" or \"emergency plumbing repair\" needs your phone number visible immediately, not buried at the bottom. Someone in a flooding kitchen isn't reading three paragraphs before they call."] },
      { heading: "The map pack matters more than the blog", paragraphs: ["For plumbers specifically, a fully optimized Google Business Profile with accurate service areas and fast review response usually moves the needle faster than content alone. Content still matters for the searches that aren't emergencies, like water heater replacement or repiping, where people compare options first."] },
    ],
  },
  {
    ...
    relatedLabel: "See our SEO service",
    sections: [
      { paragraphs: ["Roofing leads split into two categories that behave nothing alike: storm damage that needs an answer today, and a planned roof replacement someone has been putting off for months. Treating them the same on your website loses leads on both sides."] },
      { heading: "Storm and emergency pages", paragraphs: ["A dedicated page for storm damage repair and insurance claim help, built to load fast and get a call started immediately, catches the urgent searches. This is not the place for a long explanation of roofing materials."] },
      { heading: "Planned replacement pages", paragraphs: ["Someone planning a full roof replacement is comparing materials, pricing ranges, and companies over days or weeks. This is where real educational content, honest pricing ranges, and past work actually earn the click."] },
    ],
  },
  {
  ...
  // ---------- B. Vertical-specific web design (10) ----------
  {
    ...
    sections: [
      { paragraphs: ["A plumber's website has one real job on most visits: get someone to call, fast. Design decisions should be judged against that, not against how impressive the site looks in a portfolio."] },
      { heading: "Click to call, always visible", paragraphs: ["The phone number should be tappable and visible in the header on every page, on both mobile and desktop, not buried in a contact page. A lot of plumbing sites lose calls simply because the number takes too many taps to find."] },
      { heading: "Separate emergency from planned work", paragraphs: ["A visitor with a flooding basement and a visitor planning a water heater upgrade need different experiences. The homepage should route each of them to the right page immediately instead of treating every visitor the same."] },
    ],
  },
  {
    ...
    relatedLabel: "See our web design service",
    sections: [
      { paragraphs: ["Roofing sales cycles range from same day storm damage to a decision that takes weeks. A single website needs to serve both without making either kind of visitor feel unheard."] },
      { heading: "Photos carry more weight than copy", paragraphs: ["Real before and after photos of completed roofs, organized by material and style, do more convincing than paragraphs of description. Roofing is a highly visual purchase decision."] },
      { heading: "Financing and insurance help visible early", paragraphs: ["Since a full roof replacement is a major expense, a visible mention of financing options or insurance claim assistance removes a real hesitation before someone even requests a quote."] },
    ],
  },
  {
  ...
  // ---------- C. Vertical-specific reviews (8) ----------
  {
    ...
    sections: [
      { paragraphs: ["The best moment to ask a plumbing customer for a review is standing right there after the job is done and the problem is actually fixed, while relief is still fresh."] },
      { heading: "Keep the ask simple", paragraphs: ["A short, direct request, ideally with a text message containing a direct link sent on the spot, gets far more responses than a generic follow up email sent days later."] },
      { heading: "Respond to what comes back", paragraphs: ["A quick, genuine thank you on every review that comes in, and a calm, professional response to any negative one, shows future customers there's a real person paying attention."] },
    ],
  },
  {
    ...
    relatedLabel: "See our reviews service",
    sections: [
      { paragraphs: ["A roof replacement is one of the larger purchases a homeowner makes, and larger purchases get researched more carefully. Reviews carry outsized weight in that research."] },
      { heading: "Ask before the crew leaves", paragraphs: ["The final walkthrough, when the customer can see the finished roof, is the strongest moment to ask, not a follow up call a week later once the excitement has faded."] },
      { heading: "Photos in reviews are a bonus worth asking for", paragraphs: ["A review with a photo of the finished roof adds real credibility that text alone doesn't. It's worth explicitly asking satisfied customers to include one if they're willing."] },
    ],
  },
  {
  ...
  // ---------- D. Vertical-specific AI automation (8) ----------
  {
    ...
    sections: [
      { paragraphs: ["Plumbing runs on urgency, which makes speed of response one of the highest value places to automate. A lead who waits too long calls someone else."] },
      { heading: "Instant response to after hours leads", paragraphs: ["An automated first response that confirms the request was received and gives a realistic timeframe keeps an after hours lead warm until a real person can call back."] },
      { heading: "Automated scheduling confirmations", paragraphs: ["Automatic appointment confirmations and reminders cut down on missed appointments and the back and forth phone tag that eats a dispatcher's day."] },
    ],
  },
  {
    ...
    relatedLabel: "See our AI automation service",
    sections: [
      { paragraphs: ["Roofing sales cycles involve a lot of manual follow up: estimates sent and never chased, insurance paperwork that piles up, and scheduling that shifts constantly with weather."] },
      { heading: "Automated estimate follow up", paragraphs: ["A sequence of automated, well timed follow up messages after an estimate is sent catches the leads that would have otherwise gone cold from nobody remembering to check back in."] },
      { heading: "Simplifying the paperwork trail", paragraphs: ["Automation connecting your CRM to document storage can keep insurance claim paperwork organized automatically instead of relying on someone manually filing it after a long day on a roof."] },
    ],
  },
  {
  ...
  // ---------- E. General SEO deep-dives (10) ----------
  {
    ...
    relatedLabel: "See our SEO service",
    sections: [
      { paragraphs: ["Keyword research sounds technical, but at its core it's just figuring out the exact words your customers actually type into Google. You don't need expensive software to start."] },
      { heading: "Start with what customers actually say", paragraphs: ["The exact phrases customers use on the phone or in person, not the industry terms you use internally, are usually the real search terms worth targeting."] },
      { heading: "Google's own autocomplete is free research", paragraphs: ["Typing a partial search into Google and looking at what it suggests, along with the \"people also ask\" section, gives real insight into related searches without paying for a tool."] },
    ],
  },
  {
  ...
  // ---------- F. General web design deep-dives (10) ----------
  {
    ...
    relatedLabel: "See our web design service",
    sections: [
      { paragraphs: ["A visually appealing website and a converting website are not automatically the same thing. Plenty of beautiful sites generate almost no business."] },
      { heading: "Clarity beats cleverness", paragraphs: ["A visitor should understand what you do and what to do next within a few seconds. Clever, ambiguous copy that requires interpretation costs conversions even when it looks impressive."] },
      { heading: "Friction is the real enemy", paragraphs: ["Every extra click, every unclear button, and every slow loading page is a small chance for a visitor to give up. Reducing friction usually matters more than adding features."] },
    ],
  },
  {
  ...
  // ---------- G. General reviews/reputation deep-dives (8) ----------
  {
    ...
    relatedLabel: "See our reviews service",
    sections: [
      { paragraphs: ["Reviews are one of the clearer, publicly acknowledged local ranking signals, but the relationship between review count, rating, and map pack position is often misunderstood."] },
      { heading: "Volume and recency both matter", paragraphs: ["A business with a large number of reviews, especially recent ones, tends to signal more real activity and trust than one with a handful of old reviews, even if the older set has a slightly higher average rating."] },
      { heading: "A perfect score isn't the goal", paragraphs: ["A realistic rating in the mid to high four star range, backed by a real volume of reviews, often reads as more credible than a suspiciously perfect five star average with very few reviews."] },
    ],
  },
  {
  ...
  // ---------- J. General mobile app deep-dives (6) ----------
  {
    ...
    sections: [
      { paragraphs: ["An app sounds impressive, but it's a real ongoing investment, and a lot of businesses assume they need one when a well built mobile website would serve the same customers just as well."] },
      { heading: "When a website is genuinely enough", paragraphs: ["If customers mostly need to find information, book an appointment, or make a single purchase occasionally, a fast, well designed mobile website usually covers that without the cost of app store maintenance."] },
      { heading: "When an app actually earns its cost", paragraphs: ["Frequent, repeat use, offline functionality, or push notifications that genuinely add value are the kinds of needs that justify building a full app instead of relying on the website alone."] },
    ],
  },
  {
  ...
  // ---------- L. Comparison / decision posts (6) ----------
  {
    ...
    relatedLabel: "See our SEO service",
    sections: [
      { paragraphs: ["SEO and paid ads both put a business in front of searchers, but they work on very different timelines and cost structures, which makes the right first choice depend on the business's situation."] },
      { heading: "Paid ads for immediate visibility", paragraphs: ["Ads can put a business at the top of search results almost immediately, which is valuable for a new business or a time sensitive promotion, but the visibility disappears the moment spending stops."] },
      { heading: "SEO for compounding, long term value", paragraphs: ["SEO takes longer to show results but keeps working without ongoing per click spending once it's built. For most established local businesses, a combination of both, weighted toward SEO over time, tends to work best."] },
    ],
  },
  {
